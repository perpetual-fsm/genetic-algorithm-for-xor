...
# 3 neurony
# każdy neuron ma 3 wagi
# każda waga ma 5 bitów
# jeden osobnik populacji = 3*3*5 = 45 bitów
...
if __name__ == '__main__':
	...
	print("sprawdzenie pisemnego:")
	scrib_weights = [1.25, 0.5, -1.75, 3.5, 1.5, -0.25,-3.5, 2.5, -1.25]
	print(fitness_function(scrib_weights, nobin=True, debug=True))